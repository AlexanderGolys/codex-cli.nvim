...
---@class CodexCli.PromptContext.Token
---@field token string
---@field label string
---@field detail string
...
---@class CodexCli.PromptContext.Capture
---@field buf integer
---@field win integer
...
--- Defines the CodexCli.PromptContext.QuickPrompt type for this module.
--- This annotation documents structured state so modules can pass data with consistent expectations.
---@class CodexCli.PromptContext.QuickPrompt
---@field id string
---@field label string
---@field text string

--- Defines the CodexCli.PromptContext type for this module.
--- This annotation documents structured state so modules can pass data with consistent expectations.
---@class CodexCli.PromptContext
local M = {}
...
local function get_selection(buf, mode)
  ...
  local start_row, start_col = table.unpack(vim.api.nvim_buf_get_mark(buf, "<"))
  local end_row, end_col = table.unpack(vim.api.nvim_buf_get_mark(buf, ">"))
...
---@return CodexCli.PromptContext.Capture?
function M.capture()
...
---@param context CodexCli.PromptContext.Capture?
---@return CodexCli.PromptContext.Token[]
...
---@param context CodexCli.PromptContext.Capture?
---@return CodexCli.PromptContext.QuickPrompt[]

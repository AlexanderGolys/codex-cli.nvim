...
local function instructions_content(project, config)
    return table.concat({
        ...
        "Do not use this file for queued prompt execution; queued prompts already manage their own local queue-file updates.",
        "",
        "",
        ...
        "11. If the project is in git and you changed code, create a focused commit for that completed task and set `history_commits` to an array containing all commit IDs (e.g. `['abc1234', 'def5678']`); for notworking prompts, preserve and append to existing commits; otherwise leave it unset.",

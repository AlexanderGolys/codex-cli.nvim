local State = require("clodex.tab.state")

--- Defines the Clodex.TabManager type for this module.
--- This annotation documents structured state so modules can pass data with consistent expectations.
---@class Clodex.TabManager
---@field states table<number, Clodex.TabState>
local Manager = {}
Manager.__index = Manager

---@return Clodex.TabManager
...
function Manager:list()
  self:cleanup()
  local ret = {} ---@type Clodex.TabState[]
...
function Manager:snapshot()
  ...
  local ret = {} ---@type Clodex.TabState.Snapshot[]

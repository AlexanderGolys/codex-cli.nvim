...
local THEME_PRESETS = {
  ...
  queue_active = {
    ...
    cursor = "ClodexQueueFocusActive",
    lcursor = "ClodexQueueFocusActive",
    cursorim = "ClodexQueueFocusActive",
    term_cursor = "ClodexQueueFocusActive",
    term_cursor_nc = "ClodexQueueFocusActive",
    winblend = 0,
  },
  queue_inactive = {
    ...
    cursor = "ClodexQueueFocusInactive",
    lcursor = "ClodexQueueFocusInactive",
    cursorim = "ClodexQueueFocusInactive",
    term_cursor = "ClodexQueueFocusInactive",
    term_cursor_nc = "ClodexQueueFocusInactive",
    winblend = 0,
  },
}
